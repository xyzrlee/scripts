...
ipsec pki --self --ca --lifetime 3650 --in private/strongswanKey.pem --type rsa --dn "C=CH, O=Aliyun-VPS, CN=$CN" --outform pem > cacerts/strongswanCert.pem
