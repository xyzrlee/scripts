...
popd
popd
[ ! -e /etc/systemd/system/shadowsocks-libev-server@.service ] && sudo cp -v systemd/shadowsocks-libev-server@.service /etc/systemd/system
[ ! -e /etc/systemd/system/shadowsocks-libev-local@.service ] && sudo cp -v systemd/shadowsocks-libev-local@.service /etc/systemd/system
